...
type ItemJson struct {
	...
	Fields   []ItemFieldJson `json:"fields"`
...
func (i *Item) JsonMarshal(hidePasswords bool) ([]byte, error) {
	var (
		fields []ItemFieldJson
		urls   []string
	)
	...
	for _, field := range detail.Fields() {
		...
		fields = append(fields, ItemFieldJson{
